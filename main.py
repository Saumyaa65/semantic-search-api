...
def startup_event() -> None:
    global documents, searcher, query_model
...
def query_documents(payload: QueryRequest) -> QueryResponse:
	if searcher is None or query_model is None:
	...
	if cached_result is not None:
		return QueryResponse(query=payload.query, cache_hit=True, results=cached_result)
